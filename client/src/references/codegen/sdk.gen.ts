...
export const postApiTodoItemsBulk = <ThrowOnError extends boolean = false>(options?: OptionsLegacyParser<PostApiTodoItemsBulkData, ThrowOnError>) => {
    return (options?.client ?? client).post<PostApiTodoItemsBulkResponse, PostApiTodoItemsBulkError, ThrowOnError>({
        ...options,
        url: '/api/TodoItems/bulk'
    });
};